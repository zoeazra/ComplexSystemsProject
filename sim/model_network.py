...
def run_network_sim(
    ...
    #for time in range(int(epoch), int(epoch + endtime), timestep):
        ...
        #     file_sys.write(time, current_time, len(collision_pairs), total_debris_generated_this_epoch, falldown_number, len(objects_fast), 0, file_sys.SIMU_RESULT_PATH, f"Group_{group}")
